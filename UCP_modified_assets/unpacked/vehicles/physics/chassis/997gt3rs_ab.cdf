// NFS  Porsche 997 GT3 RS Auto-Bild Racecar  chassis definition file.
...
Mass=1250.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1615.0,1730.0,355.00)    // all inertia except fuel
...
CGRearSetting=0
GraphicalOffset=(0.0, 0.015, 0.0) // does not affect physics!
...
RWCenter=(0.00, 0.200, 0.75)     // center of rear wing forces (offset from center of rear axle at ref plane)
