...
Mass=1140.0                      // all mass except fuel  (750kg car + 80kg driver weight)
Inertia=(1440.0,1560.0,320.0)    // all inertia except fuel
...
Notes=""
Symmetric=1
CGHeight=0.235                  // height of body mass (excluding fuel) above reference plane
...
Undertray00=(0.80,  0.02, -1.805)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.02, -1.805)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
FWDragParams=(0.03, 0.006, 0.0001)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.160, -0.0165, 0.00002)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.03, 0.006, 0.0001)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.250, -0.0190, 0.00002)  // base lift and 1st and 2nd order with setting
...
FinalDriveSetting=36                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=6
Gear1Setting=0
Gear2Setting=26
...
DiffPowerSetting=9                 // (not implemented for four-wheel drive)
...
SpringSetting=0
RideHeightRange=(0.095, -0.0041, 10)
RideHeightSetting=0
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(55000.0, 4533.0, 6)
SpringSetting=0
RideHeightRange=(0.095, -0.00365, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(3000.0, 300.0, 6)
SlowBumpSetting=0
