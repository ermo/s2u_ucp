// Koenesegg CCX Chassis Car file.
...
Mass=1200.0                      // all mass except fuel  (750kg car + 80kg driver weight)
Inertia=(1560.0,1690.0,350.0)    // all inertia except fuel
...
FWDragParams=(0.04, 0.007, 0.0001)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.190, -0.020, 0.00002)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.04, 0.008, 0.0001)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.280, -0.026, 0.00002)  // base lift and 1st and 2nd order with setting
...
BodyRot=(3.70, 3.3, 1.55)         // aero torque from rotating 
...
SpringSetting=0
RideHeightRange=(0.095, -0.0035, 10)
RideHeightSetting=0
...
BrakeTorque=4200.0                  // maximum brake torque at zero wear and optimum temp
...
SpringSetting=0
RideHeightRange=(0.105, -0.0035, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
