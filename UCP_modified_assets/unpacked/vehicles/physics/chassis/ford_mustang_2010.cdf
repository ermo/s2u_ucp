// NFS PS2 Ford Shelby GT500 2010 high-detail Car parameter file
...
Mass=1780.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2405.0,2560.0,480.0)    // all inertia except fuel
...
Undertray02=(0.80,  0.02, 1.00)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.80, 0.02, 1.00)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWLiftParams=(-0.100, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.140, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
SpringSetting=0
RideHeightRange=(0.140, -0.0055, 10)
RideHeightSetting=0
