// NFS PS2 Lancia Delta EVO 4wd street car  chassis definition file.
//
[GENERAL]
...
Mass=1300.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1550.0,1660.0,350.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.130)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
RWDragParams=(0.07, 0.003, 0.0001)        // base drag and 1st and 2nd order with setting
...
DownshiftClutchTime=0.25           // time to ease auto-clutch in AFTER downshift (used to be SemiAutoClutchTime, note that the shift will complete significantly before the clutch is fully engaged)
...
SpringRange=(55000.0, 4583.0, 6)
SpringSetting=0
RideHeightRange=(0.128, -0.0065, 10)
RideHeightSetting=0
...
BrakeTorque=2700.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00030                 // heat added linearly with brake torque
