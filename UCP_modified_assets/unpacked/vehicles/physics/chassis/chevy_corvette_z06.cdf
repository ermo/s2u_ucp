//Corvette Z-06 high-detail Car parameter file
...
Mass=1420.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1980.0,2060.0,400.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.240)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
SpinInertia=1.500                   // inertia in pitch direction including any axle
...
RideHeightSetting=0
DamperMult=1.00                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(3600.0, 300.0, 11)
SlowBumpSetting=0
FastBumpRange=(1800.0, 200.0, 11)
FastBumpSetting=0
