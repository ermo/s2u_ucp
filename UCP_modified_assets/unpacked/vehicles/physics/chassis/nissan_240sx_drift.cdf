// NFS PS2 Nissan 200SX Drift Tutorial car  chassis definition file.
//
[GENERAL]
...
Inertia=(1450.0,1575.0,360.0)    // all inertia except fuel
...
FWSetting=                    // front wing setting
FWMaxHeight=(0.10)              // maximum height to take account of for downforce
FWDragParams=(0.008, 0.002, 0.0)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.105, -0.021, 0.0)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.008, 0.002, 0.00)        // base drag and 1st and 2nd order with setting
...
[CONTROLS]
DriftDriveTorqueMultiplier=(1.35,1.35,1.35,1.35)
...
FinalDriveSetting=18//21                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=5
Gear1Setting=6
Gear2Setting=19
...
FastBumpSetting=0
SlowReboundRange=(4000.0, 300.0, 12)
SlowReboundSetting=6
FastReboundRange=(2000.0, 300.0, 12)
...
SlowBumpSetting=0
FastBumpRange=(1250.0, 200.0, 6)
FastBumpSetting=0
SlowReboundRange=(3800.0, 300.0, 12)
SlowReboundSetting=0
FastReboundRange=(1600.0, 300.0, 12)
