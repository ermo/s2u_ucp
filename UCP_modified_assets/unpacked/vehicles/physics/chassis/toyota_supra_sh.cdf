// Toyota Supra Spedd Hunters Racecar high-detail Car parameter file
...
Inertia=(1690.0,1820.0,390.0)    // all inertia except fuel
...
CGRearSetting=0
GraphicalOffset=(0.0, 0.06, 0.0) // does not affect physics!
...
FWSetting=4                    // front wing setting
FWMaxHeight=(0.10)              // maximum height to take account of for downforce
FWDragParams=(0.070, 0.006, 0.00)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.240, -0.018, 0.00)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.070, 0.006, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.300, -0.022, 0.00)  // base lift and 1st and 2nd order with setting
...
FinalDriveSetting=31                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=6
Gear1Setting=6
Gear2Setting=28
