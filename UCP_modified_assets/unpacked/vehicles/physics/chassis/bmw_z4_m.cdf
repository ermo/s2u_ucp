// NFS PS2 BMW Z4 M street car  chassis definition file.
//
[GENERAL]
...
Mass=1470.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1800.0,1920.0,360.0)    // all inertia except fuel
...
FWLiftParams=(-0.000, -0.024, 0.0)  // base lift and 1st and 2nd order with setting
...
SpringSetting=0
RideHeightRange=(0.125, -0.00575, 10)
RideHeightSetting=0
...
SpringSetting=0
RideHeightRange=(0.130, -0.0055, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(3000.0, 300.0, 6)
SlowBumpSetting=0
