// Maserati Grand Turismo Chassis definition file.
...
Mass=1780.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
...
Undertray02=(0.80,  0.02, 1.100)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.80, 0.02, 1.100)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
SpringSetting=1
RideHeightRange=(0.120, -0.004, 10)
RideHeightSetting=0
DamperMult=1.00                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(2000.0, 300.0, 10)
SlowBumpSetting=2
FastBumpRange=(1000.0, 200.0, 10)
FastBumpSetting=2
SlowReboundRange=(8000.0, 300.0, 10)
