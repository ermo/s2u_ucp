// Lambo Gallardo GT3 high-detail Car parameter file
...
Mass=1200.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1500.0,1630.0,340.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, -0.520)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray02=(0.80,  0.02, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.80, 0.02, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWLiftParams=(-0.150, -0.025, 0.00)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.250, -0.035, 0.00)  // base lift and 1st and 2nd order with setting
RWLiftSideways=(0.0)            // dropoff in downforce with yaw (0.0 = none, 1.0 = max)
RWPeakYaw=(0.0, 0.00)           // angle of peak, multiplier at peak
RWLeft=(-1.0, 0.0, 0.0)        // aero forces from moving left
RWRight=(1.0, 0.0, 0.0)        // aero forces from moving right
...
FinalDriveSetting=32                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=6
Gear1Setting=4
Gear2Setting=24
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=3900.0                  // maximum brake torque at zero wear and optimum temp
