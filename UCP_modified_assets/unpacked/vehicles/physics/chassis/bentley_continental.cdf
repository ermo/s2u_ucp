// Bentley Continental high-detail Car parameter file
...
Mass=2040.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2750.0,2950.0,460.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.260)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.80,  0.02, -1.75)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.02, -1.75)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.80,  0.02, 0.800)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.80, 0.02, 0.800)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWDragParams=(0.06, 0.003, 0.00)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.150, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.06, 0.003, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.200, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
RWCenter=(0.00, 0.60, 0.60)     // center of rear wing forces (offset from center of rear axle at ref plane)

[BODYAERO]
BodyDragBase=(0.330)            // base drag
...
BodyRot=(5.73, 5.3, 3.87)         // aero torque from rotating 
...
BrakeDuctLift=(0.006)           // effect of brake duct setting on lift
...
UpshiftDelay=0.2                  // delay in selecting higher gear (low for semi-automatic, higher for manual)
UpshiftClutchTime=0.2             // time to ease auto-clutch in AFTER upshift (0.0 for F1 cars)
...
DownshiftBlipThrottle=0.50          // amount of throttle used to blip if controlled by game (instead of player)
...
BrakeTorque=5200.0                  // maximum brake torque at zero wear and optimum temp
...
[REARLEFT]
BumpTravel=-0.000                   // travel to bumpstop with zero packers and zero ride height
ReboundTravel=-0.210                // these two numbers assume rear ride height is 40cm to 100cm with 10cm leeway
BumpStopSpring=60000.0             // initial spring rate of bumpstop
BumpStopRisingSpring=1.25e9         // rising spring rate of bumpstop (multiplied by deflection squared)
BumpStopDamper=2500.0               // initial damping rate of bumpstop
BumpStopRisingDamper=2.19e7         // rising damper rate of bumpstop (multiplied by deflection squared)
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=4650.0                  // maximum brake torque at zero wear and optimum temp
