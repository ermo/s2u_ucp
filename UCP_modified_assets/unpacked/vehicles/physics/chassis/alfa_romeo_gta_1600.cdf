// Alfa Romeo GTA 1600 car  chassis definition file.
//
[GENERAL]
Works=0
...
Mass=800.0                      // all mass except fuel  (800kg car + 80kg driver weight)
Inertia=(1040.0,1171.0,300.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.300, 0.300)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
FuelTankMotion=(560.0,0.7)      // simple model of fuel movement in tank (spring rate per kg, critical damping ratio)
Notes=""
Symmetric=1
CGHeight=0.285                  // height of body mass (excluding fuel) above reference plane
CGRightRange=(0.50, 0.000, 0)  // fraction of weight on right tires
CGRightSetting=0
CGRearRange=(0.47, 0.005, 0)
CGRearSetting=0
...
Undertray00=(0.60,  0.02, -1.400)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.60, 0.02, -1.400)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.60,  0.02, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.60, 0.02, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
FWLiftParams=(-0.000, -0.021, 0.0)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.003, 0.003, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.000, -0.030, 0.00)  // base lift and 1st and 2nd order with setting
...
BodyLeft=(-0.70, 0.0, 0.0)       // aero forces from moving left
BodyRight=(0.70, 0.0, 0.0)       // aero forces from moving right
BodyUp=(0.0, -0.80, 0.0)         // aero forces from moving up
...
BodyRot=(3.00, 2.5, 1.00)         // aero torque from rotating 
BodyCenter=(0.0, 0.50, -1.50)   // center of body aero forces (offset from center of rear axle at ref plane)
...
FrontAntiSwayRange=(5000.0, 7500.0, 10)
...
RearAntiSwayRange=(2500.0, 3750.0, 10)
...
LeftTrackBarRange=(0.150, 0.0, 0)  // rear-left track bar
LeftTrackBarSetting=0
RightTrackBarRange=(0.220, 0.0, 0) // rear-right track bar
...
DownshiftAlgorithm=(0.85,0.75,0.75) // percentage of "optimum" downshift point in high gears, percentage of "optimum" downshift point in low gears, oval adjustment.
SteerLockRange=(0.0, 1.0, 50)
SteerLockSetting=22
DriftSteerLockSetting=50
...
DownshiftClutchTime=0.505           // time to ease auto-clutch in AFTER downshift (used to be SemiAutoClutchTime, note that the shift will complete significantly before the clutch is fully engaged)
...
FinalDriveSetting=22                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=4
Gear1Setting=2
Gear2Setting=25
...
SpringRange=(35000.0, 3888.0, 6)
SpringSetting=0
RideHeightRange=(0.140, -0.005, 10)
RideHeightSetting=0
...
FastBumpSetting=0
SlowReboundRange=(3000.0, 300.0, 6)
SlowReboundSetting=0
FastReboundRange=(1500.0, 300.0, 6)
...
BrakeHeating=0.00090                 // heat added linearly with brake torque
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=1100.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00090                 // heat added linearly with brake torque
