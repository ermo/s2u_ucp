// Mazda RX7 SH Drift car chassis definition file.
//
[GENERAL]
...
Inertia=(1500.0,1650.0,400.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.180)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.75,  0.02, -1.600)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.75, 0.02, -1.600)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
FWDragParams=(0.005, 0.002, 0.0)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.300, -0.021, 0.0)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.005, 0.003, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.500, -0.026, 0.00)  // base lift and 1st and 2nd order with setting
...
RWRot=(1.7, 1.4, 0.75)        // aero torque from rotating
...
SpinInertia=1.150                   // inertia in pitch direction including any axle
...
FastBumpSetting=0
SlowReboundRange=(6000.0, 300.0, 6)
...
BrakeCooling=(1.95e-002,0.655e-004)  // minimum brake cooling rate (static and per unit velocity)
...
SpinInertia=1.227                   // inertia in pitch direction including any axle
...
SpringSetting=2
RideHeightRange=(0.125, -0.0055, 10)
RideHeightSetting=5
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(2500.0, 300.0, 6)
SlowBumpSetting=0
FastBumpRange=(1200.0, 200.0, 6)
FastBumpSetting=0
...
BrakePadSetting=2
BrakeDiscInertia=0.001              // inertia per meter of thickness
BrakeOptimumTemp=350.0              // optimum brake temperature in Celsius (peak brake grip)
...
BrakeCooling=(1.10e-002,0.520e-004)  // minimum brake cooling rate (static and per unit velocity)
