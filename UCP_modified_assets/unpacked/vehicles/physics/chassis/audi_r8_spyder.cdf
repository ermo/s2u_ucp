// Audi R-8 spyder high-detail Car parameter file
...
Mass=1585.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1820.0,1970.0,355.0)    // all inertia except fuel
...
Undertray00=(0.85,  0.02, -1.6)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.85, 0.02, -1.6)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.85,  0.02, 1.0)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.85, 0.02, 1.0)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWCenter=(0.00, 0.20, -0.70)    // center of front wing forces (offset from center of front axle in ref plane)
...
RWLiftParams=(-0.250, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
RWCenter=(0.00, 0.40, 0.55)     // center of rear wing forces (offset from center of rear axle at ref plane)

[BODYAERO]
BodyDragBase=(0.250)            // base drag
...
BodyRot=(3.73, 3.3, 1.87)         // aero torque from rotating 
...
DiffPumpSetting=10
DiffPowerRange=(0.0,0.0,20)        // fraction of power-side input torque transferred through diff
DiffPowerSetting=0                // (not implemented for four-wheel drive)
DiffCoastRange=(0.0,0.0,20)        // fraction of coast-side input torque transferred through diff
...
SpringSetting=3
RideHeightRange=(0.100, -0.0041, 10)
RideHeightSetting=0
...
SpringSetting=3
RideHeightRange=(0.120, -0.0041, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(4000.0, 300.0, 11)
SlowBumpSetting=6
