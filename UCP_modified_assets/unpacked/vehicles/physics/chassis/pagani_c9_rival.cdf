...
Mass=1250.0                      // all mass except fuel  (750kg car + 80kg driver weight)
Inertia=(1570.0,1720.0,330.0)    // all inertia except fuel
...
FWDragParams=(0.04, 0.002, 0.0001)        // base drag and 1st and 2nd order with setting
...
UpshiftDelay=0.06                  // delay in selecting higher gear (low for semi-automatic, higher for manual)
