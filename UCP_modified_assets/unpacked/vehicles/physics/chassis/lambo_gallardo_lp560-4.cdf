// Lamborghini_Murcielago_LP640 Chassis Car file.
...
Mass=1569.0                      // all mass except fuel  (750kg car + 80kg driver weight)
Inertia=(1975.0,2100.0,370.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, -0.530)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
CGRearSetting=0
GraphicalOffset=(0.0, 0.0, 0.00) // does not affect physics!
CollisionOffset=(0.0, 0.02, 0.0) // Moves collision mesh independently of G'offset
Undertray00=(0.90,  0.020, -1.65)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.90, 0.020, -1.65)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.90,  0.020, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.90, 0.020, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
FWDragParams=(0.04, 0.003, 0.0001)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.080, -0.033, 0.00002)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.118, -0.0380, 0.00002)  // base lift and 1st and 2nd order with setting
...
RWCenter=(0.00, 0.60, 0.70)     // center of rear wing forces (offset from center of rear axle at ref plane)
...
BodyRot=(4.50, 4.2, 2.70)         // aero torque from rotating 
...
BrakeDuctDrag=(0.00)           // effect of brake duct setting on drag
BrakeDuctLift=(0.00)           // effect of brake duct setting on lift

[DIFFUSER]
DiffuserBase=(-0.100, -0.50, 5.0) // base lift and 1st/2nd order with rear ride height
...
SpringSetting=0
RideHeightRange=(0.115, -0.004, 10)
RideHeightSetting=0
...
SpringSetting=0
RideHeightRange=(0.120, -0.0045, 10)
RideHeightSetting=0
DamperMult=1.00                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(4000.0, 300.0, 6)
SlowBumpSetting=0
...
BrakeHeating=0.0004                 // heat added linearly with brake torque
