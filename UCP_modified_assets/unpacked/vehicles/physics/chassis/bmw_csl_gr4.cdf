// NFS 1975 BMW 3.0 CSL Group4 race car  chassis definition file.
//
[GENERAL]
Works=0
...
Mass=1064.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1360.0,1480.0,340.0)    // all inertia except fuel
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=1850.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00050                 // heat added linearly with brake torque
