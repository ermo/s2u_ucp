// NFS PS Acura NSX  chassis definition file.
...
Inertia=(1650.0,1736.0,360.00)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, -0.400)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
FWLiftParams=(-0.100, -0.018, 0.0)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.160, -0.026, 0.000)  // base lift and 1st and 2nd order with setting
...
BodyRot=(2.45, 2.2, 1.20)         // aero torque from rotating 
