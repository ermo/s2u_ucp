// NFS PS2 Corvett Z-06 high-detail Car parameter file
...
Mass=1620.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2100.0,2260.0,430.0)    // all inertia except fuel
...
BodyFore=(0.0, -0.1412, 0.435)  // aero forces from moving forwards (lift value important!)
...
SpinInertia=1.800                   // inertia in pitch direction including any axle
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(55000.0, 5416.0, 6)
SpringSetting=0
RideHeightRange=(0.110, -0.0035, 10)
RideHeightSetting=0
DamperMult=1.00                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(4000.0, 300.0, 11)
SlowBumpSetting=0
