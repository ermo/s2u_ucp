...
Mass=1380.0                      // all mass except fuel  (750kg car + 80kg driver weight)
Inertia=(1800.0,1930.0,380.0)    // all inertia except fuel
...
SpringSetting=0
RideHeightRange=(0.095, -0.004, 10)
RideHeightSetting=0
...
FastBumpSetting=0
SlowReboundRange=(6000.0, 600.0, 6)
SlowReboundSetting=0
FastReboundRange=(3000.0, 600.0, 6)
...
SpringSetting=0
RideHeightRange=(0.125, -0.00675, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(4000.0, 300.0, 6)
SlowBumpSetting=0
