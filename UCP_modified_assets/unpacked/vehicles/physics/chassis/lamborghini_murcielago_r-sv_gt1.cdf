...
Mass=1250.0                      // all mass except fuel
Inertia=(1500.0,1600.0,310.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, -1.220)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.80,  0.02, -1.80)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.02, -1.80)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.80,  0.02, 1.10)  // offset from center of car, and between axles // LR (Left rear corner of diffuser)
Undertray03=(-0.80, 0.02, 1.10)  // offset from center of car, and between axles // RR (Right rear corner of diffuser)
...
AITorqueStab=(1.60, 1.60, 1.60)   // torque adjustment to keep AI stable
...
FWDragParams=(0.04, 0.004, 0.0004)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.190, -0.025, 0.00003)  // base lift and 1st and 2nd order with setting
...
FWLeft=(-0.15, 0.0, 0.0)        // aero forces from moving left
FWRight=(0.15, 0.0, 0.0)        // aero forces from moving right
...
RWDragParams=(0.05, 0.005, 0.0004)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.270, -0.034, 0.00002)  // base lift and 1st and 2nd order with setting
RWLiftSideways=(0.0)            // dropoff in downforce with yaw (0.0 = none, 1.0 = max)
RWPeakYaw=(0.0, 0.00)          // angle of peak, multiplier at peak
RWLeft=(-0.70, 0.0, 0.0)        // aero forces from moving left
RWRight=(0.70, 0.0, 0.0)        // aero forces from moving right
...
RWCenter=(0.00, 0.50, 0.75)     // center of rear wing forces (offset from center of rear axle at ref plane)
...
[DIFFUSER]
DiffuserBase=(-0.600, -0.50, 5.0) // base lift and 1st/2nd order with rear ride height
...
DownshiftClutchTime=0.40           // time to ease auto-clutch in AFTER downshift (used to be SemiAutoClutchTime, note that the shift will complete significantly before the clutch is fully engaged)
...
FinalDriveSetting=30                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=6
Gear1Setting=0
Gear2Setting=21
...
ReboundTravel=-0.140                // these two numbers assume front ride height is 30cm to 90cm with 10cm leeway
...
PushrodSpindle=(-0.100, -0.150, 0.000) // relative to spindle
PushrodBody=(-0.100, 0.320, 0.000)   // spring/damper connection to body (relative to wheel center)
...
BrakeFadeRange=1500.0               // temperature outside of optimum that brake grip drops to half (too hot or too cold)
...
BrakeTorque=5000.00                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00045                 // heat added linearly with brake torque
BrakeCooling=(1.20e-002,0.600e-004)  // minimum brake cooling rate (static and per unit velocity)
BrakeDuctCooling=1.800e-004         // brake cooling rate per brake duct setting
...
[REARLEFT]
BumpTravel=-0.000                   // travel to bumpstop with zero packers and zero ride height
ReboundTravel=-0.160                // these two numbers assume rear ride height is 40cm to 100cm with 10cm leeway
BumpStopSpring=60000.0             // initial spring rate of bumpstop
BumpStopRisingSpring=1.25e9         // rising spring rate of bumpstop (multiplied by deflection squared)
BumpStopDamper=2500.0               // initial damping rate of bumpstop
BumpStopRisingDamper=2.19e7         // rising damper rate of bumpstop (multiplied by deflection squared)
...
SpinInertia=1.750                   // inertia in pitch direction including any axle
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=4000.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00035                 // heat added linearly with brake torque
BrakeCooling=(1.000e-002,0.600e-004)  // minimum brake cooling rate (static and per unit velocity)
...
BrakeTorque=4000.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00035                 // heat added linearly with brake torque
BrakeCooling=(1.00e-002,0.600e-004)  // minimum brake cooling rate (static and per unit velocity)
BrakeDuctCooling=1.760e-004         // brake cooling rate per brake duct setting
