//Ford Mustang GT3 Racecar high-detail Car parameter file
...
Inertia=(1625.0,1780.0,350.0)    // all inertia except fuel
...
Undertray00=(0.90,  0.04, -1.895)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.90, 0.04, -1.895)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.90,  0.04, 0.800)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.90, 0.04, 0.800)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
RWLiftParams=(-0.190, -0.038, 0.00)  // base lift and 1st and 2nd order with setting
