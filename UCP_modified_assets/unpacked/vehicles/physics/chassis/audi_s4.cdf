// NFS PS3 Audi S4  high-detail Car parameter file
...
Mass=1815.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2300.0,2400.0,450.0)    // all inertia except fuel
...
FWDragParams=(0.05, 0.002, 0.0)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.000, -0.020, 0.0)  // base lift and 1st and 2nd order with setting
...
FWCenter=(0.00, -0.200, -0.50)    // center of front wing forces (offset from center of front axle in ref plane)
...
RWLiftParams=(-0.00, -0.027, 0.00)  // base lift and 1st and 2nd order with setting
...
BodyMaxHeight=(0.0)            // maximum ride height that affects drag/lift
...
RearAntiSwayRange=(6000.0, 6000.0, 8)
...
SteeringFFBMult=1.0
UpshiftAlgorithm=(0.96,0.0) //  percentage of the rev limit to upshift at.  If the 2nd value is non-zero, then we will use it as the exact RPM to upshift at.
...
SpringRange=(72000.0, 12000.0, 6)
SpringSetting=0
RideHeightRange=(0.115, -0.0045, 10)
RideHeightSetting=0
