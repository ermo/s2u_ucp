// Maserati_MC12 GT1 high-detail Car parameter file
...
Inertia=(1570.0,1690.0,320.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, -0.800)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
FWLiftParams=(-0.180, -0.030, 0.00)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.265, -0.038, 0.00)  // base lift and 1st and 2nd order with setting
...
[DIFFUSER]
DiffuserBase=(-0.700, -0.50, 5.0) // base lift and 1st/2nd order with rear ride height
...
CorrectedInnerSuspHeight=-1 //.170        // instead of moving inner susp height relative with ride height, use this offset (set to -1 for original behavior)
...
BrakeTorque=4800.0                  // maximum brake torque at zero wear and optimum temp
