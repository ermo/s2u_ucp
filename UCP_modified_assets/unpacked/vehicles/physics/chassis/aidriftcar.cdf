// NFS PS2 Pontiac GTO  high-detail Car parameter file
...
Mass=1600.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2251.0,2400.0,450.0)    // all inertia except fuel
...
Notes=""
Symmetric=1
CGHeight=0.350                  // height of body mass (excluding fuel) above reference plane
...
[REARWING]
RWRange=(0.0, 1.0, 18.0)          // rear wing range
...
RWLeft=(-0.2, 0.0, 0.0)        // aero forces from moving left
RWRight=(0.2, 0.0, 0.0)        // aero forces from moving right
...
BodyRot=(1.45, 1.0, 0.50)         // aero torque from rotating 
...
//Drift specific aids
StabilityControl=(0,0,0)
OppositeLock=(0,0,0)
BrakeHelp=(0,0,0)
SteeringHelp=(0,0,0)
DriftSpeedHelp=(1,0,0)
DriftYawHelp=(1,1,0)
...
SpringRange=(85000.0, 10000.0, 11)
SpringSetting=0
RideHeightRange=(0.080, 0.005, 8)
RideHeightSetting=4
...
PackerSetting=0
SpringMult=1.00                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(70000.0, 10000.0, 11)
SpringSetting=0
