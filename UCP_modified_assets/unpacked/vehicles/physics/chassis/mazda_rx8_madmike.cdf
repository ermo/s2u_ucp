// Mazda RX8 Mad Mike Drift car chassis definition file.
//
[GENERAL]
...
RWLiftParams=(-0.500, -0.030, 0.00)  // base lift and 1st and 2nd order with setting
...
SpringSetting=0
RideHeightRange=(0.095, -0.005, 10)
RideHeightSetting=5
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
