// BMW Z4 FIA GT3 Racecar high-detail Car parameter file
...
Mass=1150.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1495.0,1620.0,340.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.170)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray02=(0.80,  0.02, 0.950)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.80, 0.02, 0.950)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWLiftParams=(-0.250, -0.022, 0.00)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.300, -0.027, 0.00)  // base lift and 1st and 2nd order with setting
