// NFS PS2 Ford Shelby Mustang Terlingua high-detail Car parameter file
...
Mass=1545.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2085.0,2200.0,440.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.290)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.80,  0.02, -1.68)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.02, -1.68)  // offset from center of car, and between axles// RF (Right front corner of splitter)
