// NFS PS2 RSX street car  chassis definition file.
//
[GENERAL]
...
Mass=1309.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1500.0,1600.0,350.0)    // all inertia except fuel
...
SpringSetting=0
RideHeightRange=(0.115, -0.006, 10)
RideHeightSetting=0
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(25000.0, 4166.0, 6)
SpringSetting=0
RideHeightRange=(0.130, -0.00725, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
