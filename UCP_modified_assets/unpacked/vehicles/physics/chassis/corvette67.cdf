// Chevy Corvette 1967 427  high-detail Car parameter file
...
Inertia=(1820.0,1950.0,400.0)    // all inertia except fuel
...
Undertray02=(0.70,  0.02, 1.00)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.70, 0.02, 1.00)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
ReboundTravel=-0.220                // these two numbers assume front ride height is 30cm to 90cm with 10cm leeway
...
SpringSetting=0
RideHeightRange=(0.150, -0.0035, 10)
RideHeightSetting=0
...
[REARLEFT]
BumpTravel=-0.000                   // travel to bumpstop with zero packers and zero ride height
ReboundTravel=-0.250                // these two numbers assume rear ride height is 40cm to 100cm with 10cm leeway
BumpStopSpring=60000.0             // initial spring rate of bumpstop
BumpStopRisingSpring=1.25e9         // rising spring rate of bumpstop (multiplied by deflection squared)
BumpStopDamper=2500.0               // initial damping rate of bumpstop
BumpStopRisingDamper=2.19e7         // rising damper rate of bumpstop (multiplied by deflection squared)
...
SpringSetting=0
RideHeightRange=(0.160, -0.0035, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(2500.0, 300.0, 11)
SlowBumpSetting=0
