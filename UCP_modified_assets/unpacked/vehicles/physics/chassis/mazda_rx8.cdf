// NFS PS2 Mazda RX8 street car  chassis definition file.
//
[GENERAL]
...
Mass=1392.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1700.0,1800.0,450.0)    // all inertia except fuel
...
Undertray00=(0.75,  0.02, -1.750)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.75, 0.02, -1.750)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
FinalDriveSetting=16                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=6
Gear1Setting=0
Gear2Setting=19
