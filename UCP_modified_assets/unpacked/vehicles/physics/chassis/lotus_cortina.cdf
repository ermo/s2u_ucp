// Lotus Cortina car  chassis definition file.
//
[GENERAL]
Works=0
...
Mass=830.0                      // all mass except fuel  (800kg car + 80kg driver weight)
Inertia=(1080.0,1200.0,330.0)    // all inertia except fuel
...
CGRightRange=(0.505, 0.000, 0)  // fraction of weight on right tires
CGRightSetting=0
CGRearRange=(0.47, 0.005, 0)
CGRearSetting=0
GraphicalOffset=(0.0, 0.00, 0.0) // does not affect physics!
CollisionOffset=(0.0, 0.00, 0.0) // Moves collision mesh independently of G'offset
...
FinalDriveSetting=24                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=4
Gear1Setting=2
Gear2Setting=25
