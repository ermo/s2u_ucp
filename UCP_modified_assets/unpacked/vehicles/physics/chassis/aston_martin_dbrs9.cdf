//Aston-Martin DBRS9 GT3 Racecar high-detail Car parameter file
...
Mass=1275.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1700.0,1820.0,340.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.190)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.80,  0.04, -1.70)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.04, -1.70)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.80,  0.04, 1.00)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.80, 0.04, 1.00)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
