// Jaguar E-Type Lightweight 1965  high-detail Car parameter file
...
Mass=1030.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1340.0,1470.0,330.0)    // all inertia except fuel
...
Undertray00=(0.65,  0.02, -1.895)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.65, 0.02, -1.895)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.65,  0.02, 0.800)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.65, 0.02, 0.800)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
PackerSetting=0
SpringMult=1.00                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(40000.0, 2916.0, 3)
SpringSetting=1
RideHeightRange=(0.150, -0.005, 8)
RideHeightSetting=0
DamperMult=1.00                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
