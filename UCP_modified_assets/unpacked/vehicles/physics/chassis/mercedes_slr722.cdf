// NFS PS2 Mercedes SLR 722 high-detail Car parameter file
...
Mass=1768.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2280.0,2400.0,430.0)    // all inertia except fuel
...
BodyRot=(5.73, 5.3, 2.87)         // aero torque from rotating 
...
SpringRange=(80000.0, 6670.0, 6)
SpringSetting=0
RideHeightRange=(0.110, -0.00525, 10)
RideHeightSetting=0
...
SpringSetting=0
RideHeightRange=(0.115, -0.00525, 10)
RideHeightSetting=0
DamperMult=1.00                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(4000.0, 300.0, 11)
SlowBumpSetting=1
