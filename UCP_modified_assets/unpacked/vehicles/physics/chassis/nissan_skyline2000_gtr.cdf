//Nissan Skyline 2000 GTR street car  chassis definition file.
//
[GENERAL]
TuningTier=3
...
Mass=1100.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1375.0,1500.0,340.0)    // all inertia except fuel
...
Undertray00=(0.65,  0.02, -1.600)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.65, 0.02, -1.600)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
SpringRange=(40000.0, 4444.0, 6)
SpringSetting=0
RideHeightRange=(0.135, -0.006, 10)
RideHeightSetting=0
...
SpringSetting=0
RideHeightRange=(0.145, -0.006, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
