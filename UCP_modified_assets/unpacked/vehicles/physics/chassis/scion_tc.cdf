// NFS PS2 Scion tC street car  chassis definition file.
//
[GENERAL]
...
Mass=1318.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1550.0,1650.0,360.0)    // all inertia except fuel
...
Notes=""
Symmetric=1
CGHeight=0.305                  // height of body mass (excluding fuel) above reference plane
CGRightRange=(0.50, 0.000, 0)  // fraction of weight on left tires
CGRightSetting=0
CGRearRange=(0.39, 0.000, 0)
CGRearSetting=0
...
Undertray00=(0.7,  0.02, -1.6)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.7, 0.02, -1.6)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.7,  0.02, 1.0)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.7, 0.02, 1.0)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
FWLiftParams=(-0.00, -0.020, 0.0)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.00, -0.027, 0.000)  // base lift and 1st and 2nd order with setting
...
RWCenter=(0.00, 0.400, 0.4)     // center of rear wing forces (offset from center of rear axle at ref plane)

[BODYAERO]
BodyDragBase=(0.24)            // base drag
...
SpringSetting=0
RideHeightRange=(0.130, -0.006, 10)
RideHeightSetting=0
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(25000.0, 166.0, 6)
SpringSetting=0
RideHeightRange=(0.135, -0.0065, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
