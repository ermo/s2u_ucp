// Aston Martin DBs Volante (Street) Chassis definition file.
...
Undertray00=(0.70,  0.02, -1.6)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.70, 0.02, -1.6)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.70,  0.02, 1.0)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.70, 0.02, 1.0)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
FWLiftParams=(-0.160, -0.022, 0.0)  // base lift and 1st and 2nd order with setting
...
DownshiftDelay=0.3               // delay in selecting lower gear (low for semi-automatic, higher for manual)
DownshiftClutchTime=0.3           // time to ease auto-clutch in AFTER downshift (used to be SemiAutoClutchTime, note that the shift will complete significantly before the clutch is fully engaged)
...
CGOffsetX=-0.00                     // x-offset from graphical center to physical center (NOT IMPLEMENTED)
...
SpringSetting=3
RideHeightRange=(0.105, -0.0045, 10)
RideHeightSetting=5
DamperMult=1.00                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(4000.0, 300.0, 10)
SlowBumpSetting=4
