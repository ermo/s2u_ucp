...
Mass=1776.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(2400.0,2550.0,470.0)    // all inertia except fuel
...
Undertray00=(0.85,  0.02, -1.750)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.85, 0.02, -1.750)  // offset from center of car, and between axles// RF (Right front corner of splitter)
