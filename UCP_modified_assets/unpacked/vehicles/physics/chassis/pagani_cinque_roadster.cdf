// Pagani Zonda Cinque Roadster Chassis Car file.
...
Inertia=(1550.0,1700.0,340.0)    // all inertia except fuel
...
FWDragParams=(0.01, 0.007, 0.0001)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.320, -0.017, 0.00002)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.010, 0.009, 0.0001)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.470, -0.0220, 0.00002)  // base lift and 1st and 2nd order with setting
...
UpshiftClutchTime=0.20             // time to ease auto-clutch in AFTER upshift (0.0 for F1 cars)
...
DownshiftBlipThrottle=0.30          // amount of throttle used to blip if controlled by game (instead of player)
...
SpringSetting=4
RideHeightRange=(0.120, -0.0055, 10)
RideHeightSetting=5
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
