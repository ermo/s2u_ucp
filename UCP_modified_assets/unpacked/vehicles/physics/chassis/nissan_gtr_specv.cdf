...
Mass=1675.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2200.0,2320.0,440.0)    // all inertia except fuel
...
FWLiftParams=(-0.165, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
[DIFFUSER]
DiffuserBase=(-0.110, -0.50, 5.0) // base lift and 1st/2nd order with rear ride height
...
DiffPreloadSetting=7                // (not implemented for four-wheel drive)
...
RideHeightSetting=4
DamperMult=1.20                    // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
