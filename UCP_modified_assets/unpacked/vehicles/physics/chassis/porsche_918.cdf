// Porsche Carrer GT Chassis Car file.
...
Mass=1490.0                      // all mass except fuel  (750kg car + 80kg driver weight)
Inertia=(1950.0,2170.0,380.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, -1.730)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.80,  0.020, -1.895)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.020, -1.895)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.35,  0.020, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.35, 0.020, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
FWDragParams=(0.050, 0.020, 0.0001)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.320, -0.033, 0.00002)  // base lift and 1st and 2nd order with setting
...
FWCenter=(0.00, 0.20, -0.50)    // center of front wing forces (offset from center of front axle in ref plane)

[REARWING]
RWRange=(0.0, 1.0, 10)          // rear wing range
RWSetting=0                     // rear wing setting
RWDragParams=(0.050, 0.0140, 0.0001)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.430, -0.0380, 0.00002)  // base lift and 1st and 2nd order with setting
RWLiftSideways=(0.0)            // dropoff in downforce with yaw (0.0 = none, 1.0 = max)
RWPeakYaw=(0.0, 0.00)          // angle of peak, multiplier at peak
RWLeft=(-0.1, 0.0, 0.0)        // aero forces from moving left
RWRight=(0.1, 0.0, 0.0)        // aero forces from moving right
...
RWCenter=(0.00, 0.60, 0.75)     // center of rear wing forces (offset from center of rear axle at ref plane)

[BODYAERO]
BodyDragBase=(0.29)            // base drag
...
BodyLeft=(-0.4, 0.0, 0.0)       // aero forces from moving left
BodyRight=(0.4, 0.0, 0.0)       // aero forces from moving right
...
BodyRot=(4.50, 3.2, 1.70)         // aero torque from rotating 
...
RadiatorLift=(0.000)            // effect of radiator setting on lift
...
ABSLevel=(0.30, 0.60)               // effect of grip on brakes for low ABS and high ABS
...
Gear6Setting=55
Gear7Setting=57
DiffPumpTorque=300.0                // at 100% pump diff setting, the torque redirected per wheelspeed difference in radians/sec (roughly 1.2kph)
...
SpringRange=(50000.0, 5833.0, 6)
SpringSetting=0
RideHeightRange=(0.105, -0.005, 10)
RideHeightSetting=0
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(70000.0, 7083.0, 6)
SpringSetting=0
RideHeightRange=(0.105, -0.00425, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(4000.0, 300.0, 6)
SlowBumpSetting=0
