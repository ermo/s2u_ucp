// Mercedes SLS Speed Hunters high-detail Car parameter file
...
Mass=1250.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1650.0,1770.0,345.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.160)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.80,  0.02, -1.7)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.02, -1.7)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.80,  0.02, 1.1)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.80, 0.02, 1.1)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWDragParams=(0.050, 0.006, 0.00)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.260, -0.030, 0.00)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.050, 0.006, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.300, -0.035, 0.00)  // base lift and 1st and 2nd order with setting
...
RWDown=(0.0, 0.15, 0.002)       // aero forces from moving down
...
SpringSetting=3
RideHeightRange=(0.095, -0.0045, 8)
RideHeightSetting=3
...
SpringSetting=3
RideHeightRange=(0.100, -0.0045, 8)
RideHeightSetting=4
DamperMult=1.00                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
