// Pagani Zonda F Chassis Car file.
...
Mass=1230.0                      // all mass except fuel  (750kg car + 80kg driver weight)
Inertia=(1600.0,1730.0,350.0)    // all inertia except fuel
...
Undertray00=(0.95,  0.02, -1.895)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.95, 0.02, -1.895)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.35,  0.02, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.35, 0.02, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
FWDragParams=(0.03, 0.020, 0.0001)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.280, -0.023, 0.00002)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.030, 0.0140, 0.0001)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.353, -0.0290, 0.00002)  // base lift and 1st and 2nd order with setting
...
BodyRot=(2.00, 1.5, 0.60)         // aero torque from rotating 
...
SpringSetting=0
RideHeightRange=(0.110, -0.0055, 10)
RideHeightSetting=0
...
FastBumpSetting=0
SlowReboundRange=(6500.0, 600.0, 6)
SlowReboundSetting=0
FastReboundRange=(3200.0, 600.0, 6)
FastReboundSetting=0
