// NFS PS2 Nissan S15  street car  chassis definition file.
//
[GENERAL]
...
Mass=1240.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1550.0,1650.0,400.0)    // all inertia except fuel
...
Undertray00=(0.85,  0.02, -1.700)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.85, 0.02, -1.700)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
[CONTROLS]
DriftDriveTorqueMultiplier=(1.25,1.25,1.25,1.2)
...
BrakeHeating=0.00080                 // heat added linearly with brake torque
