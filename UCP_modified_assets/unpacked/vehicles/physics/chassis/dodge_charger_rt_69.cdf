// NFS Shift Dodge Charger 69-71 new high-detail Car parameter file
...
Mass=1670.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2330.0,2470.0,480.0)    // all inertia except fuel
...
Undertray00=(0.80,  0.02, -2.00)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.02, -2.00)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.80,  0.02, 1.200)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.80, 0.02, 1.200)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
BodyRot=(6.73, 5.3, 3.87)         // aero torque from rotating 
BodyCenter=(0.0, 0.50, -2.3)   // center of body aero forces (offset from center of rear axle at ref plane)
...
ReboundTravel=-0.260                // these two numbers assume front ride height is 30cm to 90cm with 10cm leeway
...
SpringRange=(50000.0, 6666.0, 6)
SpringSetting=0
RideHeightRange=(0.170, -0.006, 10)
RideHeightSetting=0
...
[REARLEFT]
BumpTravel=-0.000                   // travel to bumpstop with zero packers and zero ride height
ReboundTravel=-0.280                // these two numbers assume rear ride height is 40cm to 100cm with 10cm leeway
BumpStopSpring=60000.0             // initial spring rate of bumpstop
BumpStopRisingSpring=1.25e9         // rising spring rate of bumpstop (multiplied by deflection squared)
BumpStopDamper=2500.0               // initial damping rate of bumpstop
BumpStopRisingDamper=2.19e7         // rising damper rate of bumpstop (multiplied by deflection squared)
...
PackerSetting=0
SpringMult=1.00                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(40000.0, 5000.0, 6)
SpringSetting=0
RideHeightRange=(0.180, -0.0065, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(3000.0, 300.0, 11)
SlowBumpSetting=0
FastBumpRange=(1500.0, 200.0, 11)
FastBumpSetting=0
SlowReboundRange=(5000.0, 300.0, 16)
SlowReboundSetting=0
FastReboundRange=(2500.0, 300.0, 16)
FastReboundSetting=0
