// NFS PS2 VW Scirroco  street car  chassis definition file.
//
[GENERAL]
...
Mass=1350.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1650.0,1750.0,370.0)    // all inertia except fuel
...
Undertray00=(0.70,  0.02, -1.50)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.70, 0.02, -1.50)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
SpringSetting=0
RideHeightRange=(0.100, -0.0035, 10)
RideHeightSetting=0
