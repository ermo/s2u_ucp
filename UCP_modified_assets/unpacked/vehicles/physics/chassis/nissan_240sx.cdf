// NFS PS2 Nissan 200SX street car  chassis definition file.
//
[GENERAL]
...
Inertia=(1500.0,1630.0,380.0)    // all inertia except fuel
DriftInertia=(1350.0,1475.0,450.0)    // all inertia except fuel
...
Undertray00=(0.75,  0.02, -1.400)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.75, 0.02, -1.400)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
FastReboundRange=(1700.0, 300.0, 6)
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(30000.0, 7500.0, 6)
SpringSetting=0
RideHeightRange=(0.130, -0.007, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(2200.0, 300.0, 6)
SlowBumpSetting=0
