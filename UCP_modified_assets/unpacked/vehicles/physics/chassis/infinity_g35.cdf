// NFS PS2 Infiniti G35 street car  chassis definition file.
//
[GENERAL]
...
DriftInertia=(2000.0,2020.0,450.0)    // all inertia except fuel
...
Undertray00=(0.75,  0.02, -1.800)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.75, 0.02, -1.800)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
SpinInertia=1.550                   // inertia in pitch direction including any axle
