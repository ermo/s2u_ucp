// NFS PS2 Lotus Exige S street car  chassis definition file.
//
[GENERAL]
...
Mass=944.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1200.0,1300.0,300.0)    // all inertia except fuel
...
AITorqueStab=(1.80, 2.00, 1.80)   // torque adjustment to keep AI stable
...
FWLiftParams=(-0.150, -0.014, 0.0)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.280, -0.024, 0.00)  // base lift and 1st and 2nd order with setting
...
FinalDriveSetting=18                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=6
Gear1Setting=1
Gear2Setting=24
...
SpringSetting=3
RideHeightRange=(0.120, -0.0065, 10)
RideHeightSetting=4
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=1650.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00050                 // heat added linearly with brake torque
