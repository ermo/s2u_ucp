// NFS PS2 Dodge Challenger new high-detail Car parameter file
...
Mass=1750.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2360.0,2500.0,470.0)    // all inertia except fuel
...
Undertray02=(0.90,  0.02, 1.050)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.90, 0.02, 1.050)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
SpringSetting=0
RideHeightRange=(0.125, -0.0045, 10)
RideHeightSetting=0
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(60000.0, 5416.0, 6)
SpringSetting=0
RideHeightRange=(0.140, -0.0045, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
