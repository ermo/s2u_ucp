// Nissan 240ZG Speed Hunters chassis definition file.
//
[GENERAL]
...
Mass=950.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1250.0,1380.0,340.0)    // all inertia except fuel
...
Undertray00=(0.80,  0.02, -1.400)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.02, -1.400)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
FWLiftParams=(-0.100, -0.023, 0.0)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.135, -0.027, 0.00)  // base lift and 1st and 2nd order with setting
...
PackerSetting=20
SpringMult=1.2                 // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(45000.0, 3750.0, 6)
SpringSetting=2
RideHeightRange=(0.115, -0.005, 8)
RideHeightSetting=6
...
SpinInertia=1.327                   // inertia in pitch direction including any axle
