// Radical SR3 RS chassis definition file.
//
[GENERAL]
TuningTier=4
...
Mass=570.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(710.0,770.0,190.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, -0.300)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
FuelTankMotion=(560.0,0.7)      // simple model of fuel movement in tank (spring rate per kg, critical damping ratio)
Notes=""
Symmetric=1
CGHeight=0.200                  // height of body mass (excluding fuel) above reference plane
CGRightRange=(0.50, 0.000, 0)  // fraction of weight on left tires
CGRightSetting=0
CGRearRange=(0.61, 0.000, 0)
CGRearSetting=0
GraphicalOffset=(0.0, 0.010, 0.0) // does not affect physics!
CollisionOffset=(0.0, 0.04, 0.0) // Moves collision mesh independently of G'offset
Undertray00=(0.65,  0.02, -1.000)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.65, 0.02, -1.000)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.65,  0.02, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.65, 0.02, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
FuelRange=(1.0, 1.0, 35)
FuelSetting=25
NumPitstopsRange=(0, 1, 4)
NumPitstopsSetting=3
Pitstop1Range=(1.0, 1.0, 77)
Pitstop1Setting=99
Pitstop2Range=(1.0, 1.0, 77)
Pitstop2Setting=99
Pitstop3Range=(1.0, 1.0, 77)
Pitstop3Setting=99
...
AITorqueStab=(1.4, 1.40, 1.40)   // torque adjustment to keep AI stable

[FRONTWING]
FWRange=(0.0, 1.0, 10)          // front wing range
FWSetting=6                  // front wing setting
FWMaxHeight=(0.10)              // maximum height to take account of for downforce
FWDragParams=(0.06, 0.002, 0.0)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.270, -0.009, 0.0)  // base lift and 1st and 2nd order with setting
...
FWUp=(0.0, -0.20, -0.001)       // aero forces from moving up
...
RWDragParams=(0.07, 0.002, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.400, -0.014, 0.00)  // base lift and 1st and 2nd order with setting
RWLiftSideways=(0.0)            // dropoff in downforce with yaw (0.0 = none, 1.0 = max)
RWPeakYaw=(0.0, 0.00)          // angle of peak, multiplier at peak
RWLeft=(-0.3, 0.0, 0.0)        // aero forces from moving left
RWRight=(0.3, 0.0, 0.0)        // aero forces from moving right
RWUp=(0.0, -0.30, -0.002)       // aero forces from moving up
RWDown=(0.0, 0.10, 0.002)       // aero forces from moving down
...
RWCenter=(0.00, 0.200, 0.65)     // center of rear wing forces (offset from center of rear axle at ref plane)

[BODYAERO]
BodyDragBase=(0.18)            // base drag
...
BodyLeft=(-0.60, 0.0, 0.0)       // aero forces from moving left
BodyRight=(0.60, 0.0, 0.0)       // aero forces from moving right
BodyUp=(0.0, -0.70, 0.0)         // aero forces from moving up
BodyDown=(0.0, 0.3, 0.0)        // aero forces from moving down
BodyAft=(0.0, 0.2, -0.1)      // aero forces from moving rearwards
BodyFore=(0.0, -0.060, 0.435)  // aero forces from moving forwards (lift value important!)
BodyRot=(2.00, 1.7, 1.00)         // aero torque from rotating 
BodyCenter=(0.0, 0.50, -1.15)   // center of body aero forces (offset from center of rear axle at ref plane)
...
[DIFFUSER]
DiffuserBase=(-0.300, -0.50, 5.0) // base lift and 1st/2nd order with rear ride height
...
FrontAntiSwayRange=(7000.0, 7000.0, 10)
...
RearAntiSwayRange=(4000.0, 4000.0, 8)
...
FinalDriveSetting=19                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=6
Gear1Setting=10
Gear2Setting=27
...
SpinInertia=0.800                   // inertia in pitch direction including any axle
...
SpringRange=(35000.0, 2916.0, 6)
SpringSetting=0
RideHeightRange=(0.060, -0.005, 5)
RideHeightSetting=2
...
SlowBumpRange=(3300.0, 300.0, 6)
SlowBumpSetting=0
FastBumpRange=(1700.0, 200.0, 6)
FastBumpSetting=0
SlowReboundRange=(4400.0, 300.0, 6)
SlowReboundSetting=0
FastReboundRange=(2200.0, 300.0, 6)
...
SpinInertia=0.900                   // inertia in pitch direction including any axle
...
FastBumpSetting=0
SlowReboundRange=(5500.0, 300.0, 6)
SlowReboundSetting=0
FastReboundRange=(3300.0, 300.0, 6)
FastReboundSetting=0
...
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=1800.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00065                 // heat added linearly with brake torque
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=1600.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00065                 // heat added linearly with brake torque
BrakeCooling=(0.70e-002,0.520e-004)  // minimum brake cooling rate (static and per unit velocity)
BrakeDuctCooling=1.600e-004         // brake cooling rate per brake duct setting
