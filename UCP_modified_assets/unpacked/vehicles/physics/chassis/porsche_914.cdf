//  Porsche 914/6 2.0L  chassis definition file.
...
Mass=930.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1110.0,1236.0,310.00)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, -2.350)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.75,  0.02, -1.75)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.75, 0.02, -1.75)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
FWDragParams=(0.035, 0.0035, 0.0)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.040, -0.009, 0.0)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.035, 0.0035, 0.0001)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.080, -0.016, 0.000)  // base lift and 1st and 2nd order with setting
...
BodyRot=(3.45, 3.2, 1.45)         // aero torque from rotating 
BodyCenter=(0.0, 0.50, -1.35)   // center of body aero forces (offset from center of rear axle at ref plane)
...
FrontAntiSwayRange=(7500.0, 7500.0, 10)
...
RearAntiSwayRange=(3750.0, 3750.0, 10)
...
SlowBumpRange=(1800.0, 300.0, 11)
SlowBumpSetting=0
FastBumpRange=(800.0, 200.0, 11)
FastBumpSetting=0
SlowReboundRange=(4000.0, 300.0, 16)
SlowReboundSetting=0
FastReboundRange=(2000.0, 300.0, 16)
...
RideHeightSetting=5
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(1500.0, 300.0, 11)
SlowBumpSetting=0
FastBumpRange=(700.0, 200.0, 11)
FastBumpSetting=0
SlowReboundRange=(4000.0, 300.0, 16)
SlowReboundSetting=0
FastReboundRange=(2000.0, 300.0, 16)
