// Gumpert Apollo Chassis Car file.
...
Mass=1210.0                      // all mass except fuel  (750kg car + 80kg driver weight)
Inertia=(1570.0,1700.0,350.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, -0.50)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.90,  0.03, -1.895)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.90, 0.03, -1.895)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.90,  0.03, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.90, 0.03, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
[FRONTWING]
FWRange=(0.0, 1.0, 5)          // front wing range
FWSetting=1                    // front wing setting
FWMaxHeight=(0.10)              // maximum height to take account of for downforce
FWDragParams=(0.060, 0.010, 0.0001)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.220, -0.023, 0.00002)  // base lift and 1st and 2nd order with setting
...
FWUp=(0.0, -0.6, -0.001)       // aero forces from moving up
FWDown=(0.0, 0.2, 0.001)       // aero forces from moving down
...
FWCenter=(0.00, 0.00, -0.65)    // center of front wing forces (offset from center of front axle in ref plane)

[REARWING]
RWRange=(0.0, 1.0, 5)          // rear wing range
RWSetting=0                     // rear wing setting
RWDragParams=(0.060, 0.0100, 0.0001)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.330, -0.0290, 0.00002)  // base lift and 1st and 2nd order with setting
...
RWCenter=(0.00, 0.40, 0.80)     // center of rear wing forces (offset from center of rear axle at ref plane)
...
BodyRot=(3.00, 2.5, 1.60)         // aero torque from rotating 
...
[DIFFUSER]
DiffuserBase=(-0.800, -0.50, 5.0) // base lift and 1st/2nd order with rear ride height
DiffuserFrontHeight=(0.00)         // 1st order with front ride height
