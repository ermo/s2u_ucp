// NFS PS2 VW GTI and   chassis definition file.
//
[GENERAL]
TuningTier=3
...
Inertia=(1025.0,1150.0,340.0)    // all inertia except fuel
...
SpinInertia=1.127                   // inertia in pitch direction including any axle
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(20000.0, 2083.0, 6)
SpringSetting=0
RideHeightRange=(0.140, -0.0065, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=700.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00060                 // heat added linearly with brake torque
