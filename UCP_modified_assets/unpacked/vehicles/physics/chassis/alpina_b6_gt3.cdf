//BMW Alpina B6 GT3 Racecar high-detail Car parameter file
...
Inertia=(1650.0,1770.0,340.0)    // all inertia except fuel
...
Undertray00=(0.85,  0.04, -1.895)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.85, 0.04, -1.895)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.85,  0.04, 0.800)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.85, 0.04, 0.800)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWLiftParams=(-0.150, -0.033, 0.0)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.180, -0.036, 0.00)  // base lift and 1st and 2nd order with setting
...
RWCenter=(0.00, 0.200, 0.70)     // center of rear wing forces (offset from center of rear axle at ref plane)
...
FastBumpSetting=2
SlowReboundRange=(7500.0, 300.0, 16)
SlowReboundSetting=2
FastReboundRange=(3700.0, 300.0, 16)
...
BrakeTorque=4900.0                  // maximum brake torque at zero wear and optimum temp
