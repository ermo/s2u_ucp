// NFS PS2 Mazda Miata MX5 street car  chassis definition file.
//
[GENERAL]
...
Mass=1130.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1430.0,1525.0,330.0)    // all inertia except fuel
...
Undertray00=(0.65,  0.02, -1.500)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.65, 0.02, -1.500)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
RWDragParams=(0.03, 0.002, 0.00)        // base drag and 1st and 2nd order with setting
...
BodyUp=(0.0, -0.90, 0.0)         // aero forces from moving up
...
BodyRot=(3.45, 3.0, 1.30)         // aero torque from rotating 
...
DownshiftAlgorithm=(0.85,0.85,0.80) // percentage of "optimum" downshift point in high gears, percentage of "optimum" downshift point in low gears, oval adjustment.
...
BrakeTorque=2300.0                  // maximum brake torque at zero wear and optimum temp
...
SpringSetting=0
RideHeightRange=(0.120, -0.006, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(2000.0, 300.0, 6)
SlowBumpSetting=0
