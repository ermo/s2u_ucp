// 69 Mustang Vaughn Gitten Drift car  parameter file
...
Mass=1295.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1900.0,2000.0,470.0)    // all inertia except fuel
DriftInertia=(1900.0,2100.0,550.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.140)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
AITorqueStab=(1.25, 1.40, 1.25)   // torque adjustment to keep AI stable
...
FWLiftParams=(-0.180, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.240, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
SpringSetting=0
RideHeightRange=(0.125, -0.0025, 10)
RideHeightSetting=5
