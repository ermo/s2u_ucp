// Austin Mini Cooper S Legends  chassis definition file.
//
[GENERAL]
Works=0
TuningTier=3
...
Mass=700.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(840.0,900.0,220.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.050)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.55,  0.02, -1.400)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.55, 0.02, -1.400)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.55,  0.02, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.55, 0.02, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
RWDragParams=(0.03, 0.003, 0.0001)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.00, -0.024, 0.000)  // base lift and 1st and 2nd order with setting
...
RWCenter=(0.00, 0.600, 0.2)     // center of rear wing forces (offset from center of rear axle at ref plane)
...
BodyCenter=(0.0, 0.50, -1.25)   // center of body aero forces (offset from center of rear axle at ref plane)
...
FrontAntiSwayRange=(5000.0, 5000.0, 8)
...
RearAntiSwayRange=(2500.0, 2500.0, 8)
...
[CONTROLS]
ThrottleControl=(1,1,1,0)
AntilockBrakes=(2,2,2,1)
SteeringFFBMult=1.0
...
WheelDrive=FRONT                     // which wheels are driven: REAR, FOUR (even torque split), or FRONT
...
SpinInertia=0.600                   // inertia in pitch direction including any axle
...
SpringRange=(30000.0, 2916.0, 6)
SpringSetting=0
RideHeightRange=(0.130, -0.005, 10)
RideHeightSetting=0
...
FastBumpSetting=0
SlowReboundRange=(3500.0, 300.0, 6)
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=500.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00070                 // heat added linearly with brake torque
