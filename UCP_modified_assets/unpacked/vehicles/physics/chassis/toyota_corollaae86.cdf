...
Inertia=(1150.0,1250.0,310.0)    // all inertia except fuel
...
RWCenter=(0.00, 0.200, 0.5)     // center of rear wing forces (offset from center of rear axle at ref plane)
...
FinalDriveSetting=13                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=5
Gear1Setting=0
Gear2Setting=22
...
SpringSetting=0
RideHeightRange=(0.125, -0.0065, 10)
RideHeightSetting=0
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(20000.0, 1666.0, 6)
SpringSetting=0
RideHeightRange=(0.130, -0.0065, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(1500.0, 300.0, 6)
SlowBumpSetting=0
FastBumpRange=(800.0, 200.0, 6)
FastBumpSetting=0
SlowReboundRange=(2500.0, 300.0, 6)
SlowReboundSetting=0
FastReboundRange=(1200.0, 300.0, 6)
FastReboundSetting=0
