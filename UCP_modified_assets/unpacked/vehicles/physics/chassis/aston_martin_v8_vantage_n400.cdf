// NFS PS2 Aston Martin V8 Vantage N400.
//
[GENERAL]
...
Mass=1630.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(2200.0,2325.0,410.0)    // all inertia except fuel
...
Undertray00=(0.80,  0.02, -1.6)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.02, -1.6)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.80,  0.02, 1.0)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.80, 0.02, 1.0)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
SpringSetting=0
RideHeightRange=(0.110, -0.006, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(4000.0, 300.0, 6)
SlowBumpSetting=0
