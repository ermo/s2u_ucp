// Lamborghini Revention Chassis Car file.
...
Mass=1400.0                      // all mass except fuel  (750kg car + 80kg driver weight)
Inertia=(1800.0,2050.0,350.0)    // all inertia except fuel
...
Undertray00=(0.8,  0.020, -1.895)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.8, 0.020, -1.895)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.85,  0.020, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.85, 0.020, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
[FRONTWING]
FWRange=(0.0, 1.0, 18)          // front wing range
...
FWLiftParams=(-0.100, -0.033, 0.00002)  // base lift and 1st and 2nd order with setting
...
FWCenter=(0.00, 0.20, -0.55)    // center of front wing forces (offset from center of front axle in ref plane)

[REARWING]
RWRange=(0.0, 1.0, 18)          // rear wing range
RWSetting=12                     // rear wing setting
RWDragParams=(0.05, 0.003, 0.0001)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.170, -0.0380, 0.00002)  // base lift and 1st and 2nd order with setting
...
RWCenter=(0.00, 0.40, 0.75)     // center of rear wing forces (offset from center of rear axle at ref plane)
...
BodyFore=(0.0, -0.070, 0.435)  // aero forces from moving forwards (lift value important!)
...
[DIFFUSER]
DiffuserBase=(-0.200, -0.50, 5.0) // base lift and 1st/2nd order with rear ride height
...
FinalDriveSetting=29                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=6
Gear1Setting=1
Gear2Setting=29
...
SlowBumpRange=(3800.0, 300.0, 6)
SlowBumpSetting=0
FastBumpRange=(2200.0, 200.0, 6)
FastBumpSetting=0
SlowReboundRange=(8500.0, 600.0, 6)
SlowReboundSetting=0
FastReboundRange=(5000.0, 600.0, 6)
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(85000.0, 7083.0, 6)
SpringSetting=0
RideHeightRange=(0.115, -0.005, 10)
RideHeightSetting=0
DamperMult=1.00                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(3200.0, 300.0, 6)
SlowBumpSetting=0
