// Viper SRT10 high-detail Car parameter file
...
Mass=1470.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1950.0,2080.0,400.0)    // all inertia except fuel
...
Undertray00=(0.80,  0.02, -1.65)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.02, -1.65)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
FWDragParams=(0.05, 0.005, 0.00)        // base drag and 1st and 2nd order with setting
...
BrakeDuctLift=(0.00625)           // effect of brake duct setting on lift
