// BMW M3 (E36) street car  chassis definition file.
//
[GENERAL]
...
Mass=1460.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1900.0,2030.0,440.0)    // all inertia except fuel
...
Undertray00=(0.75,  0.02, -1.700)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.75, 0.02, -1.700)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
RWDragParams=(0.05, 0.004, 0.00)        // base drag and 1st and 2nd order with setting
...
FastBumpSetting=0
SlowReboundRange=(7000.0, 300.0, 6)
SlowReboundSetting=0
FastReboundRange=(3500.0, 300.0, 6)
...
BrakeTorque=2900.0                  // maximum brake torque at zero wear and optimum temp
...
SpringSetting=0
RideHeightRange=(0.115, -0.0055, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
