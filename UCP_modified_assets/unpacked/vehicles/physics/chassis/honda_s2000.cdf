// NFS PS2 Honda S2000 street car  chassis definition file.
//
[GENERAL]
...
Mass=1275.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1470.0,1595.0,320.0)    // all inertia except fuel
DriftInertia=(1570.0,1695.0,450.0)    // all inertia except fuel
...
Undertray00=(0.75,  0.02, -1.50)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.75, 0.02, -1.50)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
FWLiftParams=(-0.00, -0.022, 0.0)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.00, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
