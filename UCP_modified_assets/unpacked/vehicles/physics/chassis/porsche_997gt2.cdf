// NFS PS Porsche 997 GT2  chassis definition file.
...
Mass=1440.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1800.0,1910.0,360.00)    // all inertia except fuel
...
FWDragParams=(0.035, 0.004, 0.0)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.120, -0.027, 0.0)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.035, 0.004, 0.0001)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.190, -0.042, 0.000)  // base lift and 1st and 2nd order with setting
...
RWCenter=(0.00, 0.40, 0.8)     // center of rear wing forces (offset from center of rear axle at ref plane)
...
BodyRot=(4.45, 4.2, 2.00)         // aero torque from rotating 
...
[DIFFUSER]
DiffuserBase=(-0.100, -0.50, 5.0) // .100// base lift and 1st/2nd order with rear ride height
