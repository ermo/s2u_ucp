// NFS PS3 Audi RS4  high-detail Car parameter file
...
Mass=1650.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2200.0,2300.0,450.0)    // all inertia except fuel
...
Notes=""
Symmetric=1
CGHeight=0.310                 // height of body mass (excluding fuel) above reference plane
CGRightRange=(0.50, 0.000, 0)  // fraction of weight on left tires
CGRightSetting=0
CGRearRange=(0.45, 0.005, 0)
CGRearSetting=0
...
Undertray00=(0.75,  0.02, -1.5)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.75, 0.02, -1.5)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.75,  0.02, 1.2)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.75, 0.02, 1.2)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWDragParams=(0.05, 0.002, 0.00)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.000, -0.020, 0.00)  // base lift and 1st and 2nd order with setting
...
FWUp=(0.0, -0.3, -0.001)       // aero forces from moving up
FWDown=(0.0, 0.15, 0.001)       // aero forces from moving down
FWAft=(0.0, 0.02, -0.20)        // aero forces from moving rearwards
FWFore=(0.0, 0.0, 0.0)          // aero forces from moving forwards (recomputed from settings)
FWRot=(0.50, 0.250, 0.350)        // aero torque from rotating
...
RWDragParams=(0.05, 0.003, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.000, -0.027, 0.00)  // base lift and 1st and 2nd order with setting
...
RWRot=(0.70, 0.40, 0.50)        // aero torque from rotating
RWCenter=(0.00, 0.20, 0.60)     // center of rear wing forces (offset from center of rear axle at ref plane)

[BODYAERO]
BodyDragBase=(0.320)            // base drag
BodyDragHeightAvg=(0.00)       // drag increase with average ride height
BodyDragHeightDiff=(0.00)       // drag increase with front/rear ride height difference
...
BodyAft=(0.0, 0.50, -0.2)      // aero forces from moving rearwards
BodyFore=(0.0, -0.1600, 0.435)  // aero forces from moving forwards (lift value important!)
BodyRot=(3.45, 3.3, 1.70)         // aero torque from rotating 
...
DiffuserRake=(0.000, -0.0, 0.0)        // Optimum rake (rear - front ride height), 1st order with current difference from opt, 2nd order
...
SpinInertia=1.650                   // inertia in pitch direction including any axle
...
SpringRange=(70000.0, 7500.0, 6)
SpringSetting=0
RideHeightRange=(0.135, -0.005, 10)
RideHeightSetting=0
...
SpinInertia=1.700                   // inertia in pitch direction including any axle
