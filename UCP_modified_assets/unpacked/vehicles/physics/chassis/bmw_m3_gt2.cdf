// BMW GT2 race car  chassis definition file.
//
[GENERAL]
...
Inertia=(1560.0,1690.0,360.0)    // all inertia except fuel
...
Undertray00=(0.8,  0.02, -1.700)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.8, 0.02, -1.700)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.8,  0.02, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.8, 0.02, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
FWLiftParams=(-0.120, -0.026, 0.0)  // base lift and 1st and 2nd order with setting
