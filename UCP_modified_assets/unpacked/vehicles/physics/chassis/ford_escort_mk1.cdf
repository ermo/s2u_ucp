// Ford Escort RS1600 car  chassis definition file.
//
[GENERAL]
Works=0
...
Mass=785.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1020.0,1150.0,290.0)    // all inertia except fuel
...
FrontAntiSwayRange=(5000.0, 5000.0, 10)
...
RearAntiSwayRange=(2500.0, 2500.0, 10)
...
FinalDriveSetting=23                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=4
Gear1Setting=2
Gear2Setting=25
...
SpringSetting=0
RideHeightRange=(0.120, -0.0035, 10)
RideHeightSetting=0
...
BrakeTorque=1700.0                  // maximum brake torque at zero wear and optimum temp
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(25000.0, 2083.0, 6)
SpringSetting=0
RideHeightRange=(0.130, -0.004, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(2000.0, 300.0, 6)
SlowBumpSetting=0
