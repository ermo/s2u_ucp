// NFS PS Porsche Cayman S  chassis definition file.
...
Mass=1340.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1650.0,1736.0,350.00)    // all inertia except fuel
...
Undertray02=(0.75,  0.02, 0.900)  // offset from center of car, and between axles // LR (Left rear corner of diffuser)
Undertray03=(-0.75, 0.02, 0.900)  // offset from center of car, and between axles // RR (Right rear corner of diffuser)
...
FWLiftParams=(-0.080, -0.020, 0.0)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.160, -0.028, 0.000)  // base lift and 1st and 2nd order with setting
...
BodyRot=(1.45, 1.2, 0.60)         // aero torque from rotating 
...
ReboundTravel=-0.150                // these two numbers assume front ride height is 30cm to 90cm with 10cm leeway
...
SpringSetting=0
RideHeightRange=(0.120, -0.0061, 10)
RideHeightSetting=0
DamperMult=1.000                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
...
[REARLEFT]
BumpTravel=-0.000                   // travel to bumpstop with zero packers and zero ride height
ReboundTravel=-0.170                // these two numbers assume rear ride height is 40cm to 100cm with 10cm leeway
BumpStopSpring=60000.0             // initial spring rate of bumpstop
BumpStopRisingSpring=1.25e9         // rising spring rate of bumpstop (multiplied by deflection squared)
BumpStopDamper=2500.0               // initial damping rate of bumpstop
BumpStopRisingDamper=2.19e7         // rising damper rate of bumpstop (multiplied by deflection squared)
