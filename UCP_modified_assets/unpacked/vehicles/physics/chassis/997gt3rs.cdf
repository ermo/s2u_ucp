// Porsche 997 GT3 RS  chassis definition file.
...
Mass=1375.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1718.0,1856.0,360.00)    // all inertia except fuel
...
FWLiftParams=(-0.100, -0.020, 0.0)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.160, -0.032, 0.000)  // base lift and 1st and 2nd order with setting
...
[REARLEFT]
BumpTravel=-0.000                   // travel to bumpstop with zero packers and zero ride height
ReboundTravel=-0.190                // these two numbers assume rear ride height is 40cm to 100cm with 10cm leeway
BumpStopSpring=60000.0             // initial spring rate of bumpstop
BumpStopRisingSpring=1.25e9         // rising spring rate of bumpstop (multiplied by deflection squared)
BumpStopDamper=2500.0               // initial damping rate of bumpstop
BumpStopRisingDamper=2.19e7         // rising damper rate of bumpstop (multiplied by deflection squared)
