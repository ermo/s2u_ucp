// NFS PS2 Nissan 370Z street car  chassis definition file.
//
[GENERAL]
...
Mass=1466.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1900.0,2050.0,450.0)    // all inertia except fuel
...
Notes=""
Symmetric=1
CGHeight=0.280 //.260                 // height of body mass (excluding fuel) above reference plane
...
Undertray00=(0.85,  0.02, -1.650)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.85, 0.02, -1.650)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
FWLiftParams=(-0.100, -0.021, 0.0)  // base lift and 1st and 2nd order with setting
...
CorrectedInnerSuspHeight=-1 //0.160        // instead of moving inner susp height relative with ride height, use this offset (set to -1 for original behavior)
