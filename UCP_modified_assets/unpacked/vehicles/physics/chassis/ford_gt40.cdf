// Ford GT40 Mk1 1965 high-detail Car parameter file
...
Mass=920.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1050.0,1170.0,270.0)    // all inertia except fuel
...
Undertray02=(0.75,  0.02, 0.800)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.75, 0.02, 0.800)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWLiftParams=(-0.120, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
BrakeDuctLift=(0.004)           // effect of brake duct setting on lift
...
SpinInertia=1.222                   // inertia in pitch direction including any axle
...
SpringSetting=1
RideHeightRange=(0.100, -0.0035, 8)
RideHeightSetting=4
...
SpringSetting=1
RideHeightRange=(0.110, -0.003, 10)
RideHeightSetting=4
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(2000.0, 300.0, 11)
SlowBumpSetting=0
