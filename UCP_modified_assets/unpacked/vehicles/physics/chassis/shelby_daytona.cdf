// Ford Shelby Daytona Coupe 1965  high-detail Car parameter file
...
Undertray00=(0.70,  0.02, -1.55)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.70, 0.02, -1.55)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.70,  0.02, 0.800)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.70, 0.02, 0.800)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
AIDamperSlow=0.6                // contribution of average slow damper into simple AI damper
AIDamperFast=0.6                // contribution of average fast damper into simple AI damper
...
FWDragParams=(0.03, 0.003, 0.00)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.040, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.100, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
BodyCenter=(0.0, 0.50, -1.65)   // center of body aero forces (offset from center of rear axle at ref plane)
...
FinalDriveSetting=34                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=4
Gear1Setting=10
Gear2Setting=34
...
SpinInertia=1.20                   // inertia in pitch direction including any axle
...
SlowBumpRange=(2500.0, 400.0, 4)
SlowBumpSetting=0
FastBumpRange=(1300.0, 400.0, 4)
FastBumpSetting=0
...
BrakeTorque=2400.0                  // maximum brake torque at zero wear and optimum temp
...
SpinInertia=1.25                   // inertia in pitch direction including any axle
