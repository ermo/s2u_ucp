// Ford GT high-detail Car parameter file
...
Mass=1570.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(1900.0,2000.0,340.0)    // all inertia except fuel
...
Undertray00=(0.90,  0.02, -1.75)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.90, 0.02, -1.75)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.90,  0.02, 0.950)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.90, 0.02, 0.950)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWLiftParams=(-0.220, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
SpringSetting=0
RideHeightRange=(0.110, -0.004, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(4000.0, 300.0, 11)
SlowBumpSetting=0
