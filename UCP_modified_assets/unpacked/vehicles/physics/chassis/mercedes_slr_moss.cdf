// NFS PS2 Mercedes SLR 722 Moss version
...
Mass=1626.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2110.0,2220.0,390.0)    // all inertia except fuel
...
Undertray00=(0.90,  0.02, -2.05)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.90, 0.02, -2.05)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.90,  0.02, 0.95)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.90, 0.02, 0.95)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWDragParams=(0.06, 0.006, 0.00)        // base drag and 1st and 2nd order with setting
...
RWDragParams=(0.06, 0.006, 0.00)        // base drag and 1st and 2nd order with setting
...
BodyDown=(0.0, 0.8, 0.0)        // aero forces from moving down
...
BodyRot=(7.73, 7.3, 3.87)         // aero torque from rotating 
