// NFS PS2 Nissan GTR Spec V  high-detail Car parameter file
...
Mass=1425.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2000.0,2120.0,400.0)    // all inertia except fuel
...
FWDragParams=(0.03, 0.005, 0.00)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.200, -0.026, 0.00)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.03, 0.005, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.220, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
BodyRot=(1.73, 1.3, 0.87)         // aero torque from rotating 
...
RearAntiSwayRange=(8000.0, 8000.0, 10)
...
SpinInertia=1.522                   // inertia in pitch direction including any axle
