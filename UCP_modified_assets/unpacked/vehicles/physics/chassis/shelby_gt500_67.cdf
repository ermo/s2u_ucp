// NFS Ford Shelby GT500  high-detail Car parameter file
...
Inertia=(1984.0,2120.0,430.0)    // all inertia except fuel
...
Undertray00=(0.70,  0.02, -1.70)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.70, 0.02, -1.70)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.70,  0.02, 1.10)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.70, 0.02, 1.10)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
SpringSetting=0
RideHeightRange=(0.170, -0.0045, 10)
RideHeightSetting=0
...
SpringSetting=0
RideHeightRange=(0.180, -0.006, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(2000.0, 300.0, 11)
SlowBumpSetting=0
FastBumpRange=(1300.0, 200.0, 11)
FastBumpSetting=0
