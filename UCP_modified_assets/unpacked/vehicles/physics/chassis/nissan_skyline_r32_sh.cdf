// NFS PS2 Nissan Skyline R32 GTR Speedhunters Edition street car  chassis definition file.
...
Mass=1230.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
...
FWDragParams=(0.07, 0.003, 0.0)        // base drag and 1st and 2nd order with setting
...
Gear5Setting=58
Gear6Setting=60
DiffPumpTorque=600.00                // at 100% pump diff setting, the torque redirected per wheelspeed difference in radians/sec (roughly 1.2kph)
