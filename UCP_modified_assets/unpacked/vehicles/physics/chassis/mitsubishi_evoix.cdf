// NFS PS2 mitsubishi_evoIX MR street car  chassis definition file.
...
Mass=1450.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1700.0,1800.0,380.0)    // all inertia except fuel
...
SpringSetting=0
RideHeightRange=(0.130, -0.0075, 10)
RideHeightSetting=0
...
SpringSetting=0
RideHeightRange=(0.140, -0.0075, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
