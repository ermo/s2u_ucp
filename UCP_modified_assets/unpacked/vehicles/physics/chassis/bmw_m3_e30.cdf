// BMW M3 (E30) street car  chassis definition file.
//
[GENERAL]
TuningTier=3
...
Inertia=(1620.0,1750.0,430.0)    // all inertia except fuel
...
Undertray00=(0.75,  0.02, -1.650)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.75, 0.02, -1.650)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
FWLiftParams=(-0.080, -0.021, 0.0)  // base lift and 1st and 2nd order with setting
...
RWLiftParams=(-0.100, -0.030, 0.00)  // base lift and 1st and 2nd order with setting
