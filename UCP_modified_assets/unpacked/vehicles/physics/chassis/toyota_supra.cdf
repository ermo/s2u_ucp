// NFS PS2 Toyota Supra TT street car  chassis definition file.
//
[GENERAL]
TuningTier=3
...
Mass=1500.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1900.0,2030.0,400.0)    // all inertia except fuel
...
Undertray00=(0.70,  0.02, -1.5)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.70, 0.02, -1.5)  // offset from center of car, and between axles// RF (Right front corner of splitter)
