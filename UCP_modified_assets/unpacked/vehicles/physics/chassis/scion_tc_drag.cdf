// Chris Rado Scion TC DRAG high-detail Car parameter file
...
Mass=1100.0                      // all mass except fuel
Inertia=(1450.0,1570.0,320.0)    // all inertia except fuel
...
[FRONTWING]
FWRange=(2.0, 1.0, 10)          // front wing range
FWSetting=8                    // front wing setting
FWMaxHeight=(0.10)              // maximum height to take account of for downforce
FWDragParams=(0.070, 0.004, 0.00)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.260, -0.019, 0.00)  // base lift and 1st and 2nd order with setting
...
[REARWING]
RWRange=(2.0, 1.0, 10)          // rear wing range
RWSetting=8                   // rear wing setting
RWDragParams=(0.080, 0.006, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.290, -0.021, 0.00)  // base lift and 1st and 2nd order with setting
RWLiftSideways=(0.0)            // dropoff in downforce with yaw (0.0 = none, 1.0 = max)
RWPeakYaw=(0.0, 0.00)           // angle of peak, multiplier at peak
RWLeft=(-1.2, 0.0, 0.0)        // aero forces from moving left
RWRight=(1.2, 0.0, 0.0)        // aero forces from moving right
...
BodyRot=(4.3, 4.7, 2.25)         // aero torque from rotating 
...
ClutchEngageRate=0.95          //Auto clutch gradual engagement rate from neutral to 1st gear.
ClutchInertia=0.0048
ClutchTorque=2000.0
ClutchWear=0.0
ClutchFriction=15.000
BaulkTorque=2150.0
SemiAutomatic=0                    // whether throttle and clutch are operated automatically
UpshiftDelay=0.005                  // delay in selecting higher gear (low for semi-automatic, higher for manual)
...
DiffPumpSetting=0
DiffPowerRange=(0.00, 0.05, 20)        // fraction of power-side input torque transferred through diff
DiffPowerSetting=20                // (not implemented for four-wheel drive)
DiffCoastRange=(0.00, 0.05, 20)        // fraction of coast-side input torque transferred through diff
...
SpinInertia=1.600                   // inertia in pitch direction including any axle
...
BrakeTorque=4300.0                  // maximum brake torque at zero wear and optimum temp
