...
Mass=1888.0                      // all mass except fuel  (1800kg car + 80kg driver weight)
Inertia=(2360.0,2490.0,460.0)    // all inertia except fuel
...
Notes=""
Symmetric=1
CGHeight=0.265                  // height of body mass (excluding fuel) above reference plane
...
FWLiftParams=(-0.320, -0.020, 0.00002)  // base lift and 1st and 2nd order with setting
...
FinalDriveSetting=39                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=7
Gear1Setting=1
Gear2Setting=19
...
Gear6Setting=57
Gear7Setting=58
DiffPumpTorque=500.0                // at 100% pump diff setting, the torque redirected per wheelspeed difference in radians/sec (roughly 1.2kph)
...
SlowBumpRange=(6000.0, 300.0, 6)
SlowBumpSetting=0
FastBumpRange=(3000.0, 200.0, 6)
FastBumpSetting=0
SlowReboundRange=(9000.0, 600.0, 6)
SlowReboundSetting=0
FastReboundRange=(4500.0, 600.0, 6)
...
BrakeTorque=5400.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00025                 // heat added linearly with brake torque
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(120000.0, 20000.0, 6)
SpringSetting=0
RideHeightRange=(0.110, -0.005, 10)
RideHeightSetting=0
DamperMult=1.00                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(5000.0, 300.0, 6)
SlowBumpSetting=0
FastBumpRange=(2500.0, 200.0, 6)
FastBumpSetting=0
SlowReboundRange=(10000.0, 600.0, 6)
SlowReboundSetting=0
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(.028,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=4600.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00020                // heat added linearly with brake torque
