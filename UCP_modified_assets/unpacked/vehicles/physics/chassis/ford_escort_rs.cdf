//Ford Escort RS street car  chassis definition file.
//
[GENERAL]
TuningTier=3
...
Mass=1360.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1760.0,1890.0,400.0)    // all inertia except fuel
...
RWDragParams=(0.06, 0.003, 0.0001)        // base drag and 1st and 2nd order with setting
...
Gear5Setting=58
Gear6Setting=58
DiffPumpTorque=150.0                // at 100% pump diff setting, the torque redirected per wheelspeed difference in radians/sec (roughly 1.2kph)
