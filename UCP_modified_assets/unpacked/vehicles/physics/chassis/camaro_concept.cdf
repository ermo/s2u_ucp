// NFS PS2 Camaro high-detail Car parameter file

[GENERAL]
//AdjustableSuspensionLevelStock=1
//AdjustableSuspensionLevelLow=2
...
Mass=1705.0                      // all mass except fuel  (1395kg car + 80kg driver weight)
Inertia=(2380.0,2300.0,460.0)    // all inertia except fuel
FuelTankPos=(0.0, 0.200, 0.245)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
CGRearSetting=0
GraphicalOffset=(0.0, 0.045, 0.0) // does not affect physics!
CollisionOffset=(0.0, 0.02, 0.0) // Moves collision mesh independently of G'offset
Undertray00=(0.80,  0.02, -1.70)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.80, 0.02, -1.70)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.80,  0.02, 1.10)  // offset from center of car, and between axles // LR (Left rear corner of rocker)
Undertray03=(-0.80, 0.02, 1.10)  // offset from center of car, and between axles // RR (Right rear corner of rocker)
...
FWDragParams=(0.05, 0.003, 0.00)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.080, -0.028, 0.00)  // base lift and 1st and 2nd order with setting
...
BBodyLeft=(-0.6, 0.0, 0.0)       // aero forces from moving left
...
BodyRot=(5.73, 4.8, 2.87)         // aero torque from rotating 
...
SpringSetting=0
RideHeightRange=(0.125, -0.005, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(4000.0, 300.0, 11)
SlowBumpSetting=0
