// Toyota Corolla AE86 street/drift car  chassis definition file.
//
[GENERAL]
...
Mass=820.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1220.0,1320.0,300.0)    // all inertia except fuel
DriftInertia=(1320.0,1220.0,400.0)    // all inertia except fuel in drift mode
FuelTankPos=(0.0, 0.200, 0.150)  // location of tank affects center of gravity (very close and even slightly ahead of CG in F1)
...
Undertray00=(0.65,  0.02, -1.40)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.65, 0.02, -1.40)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.65,  0.02, 1.00)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.65, 0.02, 1.00)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
AITorqueStab=(1.40, 1.80, 1.40)   // torque adjustment to keep AI stable

[FRONTWING]
FWRange=(0.0, 1.0, 8)          // front wing range
FWSetting=5                  // front wing setting
FWMaxHeight=(0.10)              // maximum height to take account of for downforce
FWDragParams=(0.04, 0.004, 0.0)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.220, -0.022, 0.0)  // base lift and 1st and 2nd order with setting
...
FWLeft=(-0.2, 0.0, 0.0)        // aero forces from moving left
FWRight=(0.2, 0.0, 0.0)        // aero forces from moving right
...
FWRot=(1.5, 1.25, 0.65)        // aero torque from rotating
FWCenter=(0.00, -0.100, -0.55)    // center of front wing forces (offset from center of front axle in ref plane)

[REARWING]
RWRange=(0.0, 1.0, 8)          // rear wing range
RWSetting=5                    // rear wing setting
RWDragParams=(0.05, 0.005, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.260, -0.026, 0.00)  // base lift and 1st and 2nd order with setting
RWLiftSideways=(0.0)            // dropoff in downforce with yaw (0.0 = none, 1.0 = max)
RWPeakYaw=(0.0, 0.00)          // angle of peak, multiplier at peak
RWLeft=(-0.6, 0.0, 0.0)        // aero forces from moving left
RWRight=(0.6, 0.0, 0.0)        // aero forces from moving right
RWUp=(0.0, -0.60, -0.002)       // aero forces from moving up
RWDown=(0.0, 0.30, 0.002)       // aero forces from moving down
...
RWRot=(1.7, 1.4, 0.8)        // aero torque from rotating
...
[DIFFUSER]
DiffuserBase=(-0.150, -0.50, 5.0) // base lift and 1st/2nd order with rear ride height
...
UpshiftClutchTime=0.15             // time to ease auto-clutch in AFTER upshift (0.0 for F1 cars)
...
SpringSetting=0
RideHeightRange=(0.100, -0.005, 10)
RideHeightSetting=4
