// Nissan 240ZG street car  chassis definition file.
//
[GENERAL]
TuningTier=3
Works=0
...
Mass=1068.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1335.0,1450.0,330.0)    // all inertia except fuel
...
Undertray00=(0.70,  0.02, -1.400)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.70, 0.02, -1.400)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.70,  0.02, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.70, 0.02, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
DownshiftAlgorithm=(0.85,0.85,0.85) // percentage of "optimum" downshift point in high gears, percentage of "optimum" downshift point in low gears, oval adjustment.
