// Caterham R500 Superlight  chassis definition file.
//
[GENERAL]
//UpgradedTyre="Street_10"
TuningTier=3 //base upgrade level tuning allowed. (ie used so a full racecar has full adjustablity "stock")
...
Mass=600.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(700.0,790.0,200.0)    // all inertia except fuel
...
Notes=""
Symmetric=1
CGHeight=0.210                  // height of body mass (excluding fuel) above reference plane
...
CollisionOffset=(0.0, 0.05, 0.0) // Moves collision mesh independently of G'offset
Undertray00=(0.3,  0.02, -1.30)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.3, 0.02, -1.30)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.4,  0.02, 0.90)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.4, 0.02, 0.90)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
AITorqueStab=(1.50, 1.50, 1.50)   // torque adjustment to keep AI stable
...
FWDragParams=(0.03, 0.003, 0.0)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.075, -0.019, 0.0)  // base lift and 1st and 2nd order with setting
...
FWCenter=(0.00, -0.100, -0.40)    // center of front wing forces (offset from center of front axle in ref plane)

[REARWING]
RWRange=(0.0, 1.0, 10)          // rear wing range
RWSetting=0                    // rear wing setting
RWDragParams=(0.035, 0.0035, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.090, -0.024, 0.00)  // base lift and 1st and 2nd order with setting
...
RWCenter=(0.00, 0.200, 0.6)     // center of rear wing forces (offset from center of rear axle at ref plane)

[BODYAERO]
BodyDragBase=(0.28)            // base drag
...
BodyLeft=(-0.50, 0.0, 0.0)       // aero forces from moving left
BodyRight=(0.50, 0.0, 0.0)       // aero forces from moving right
BodyUp=(0.0, -0.50, 0.0)         // aero forces from moving up
BodyDown=(0.0, 0.2, 0.0)        // aero forces from moving down
...
DiffuserCenter=(0.0, 0.10, -1.10)  // center of diffuser forces (offset from center of rear axle at ref plane)
...
FrontAntiSwayRange=(6000.0, 6000.0, 10)
...
RearAntiSwayRange=(3000.0, 3000.0, 8)
...
FinalDriveSetting=27                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=6
Gear1Setting=4
Gear2Setting=25
...
SpringSetting=0
RideHeightRange=(0.090, -0.0025, 10)
RideHeightSetting=0
...
SlowBumpRange=(2500.0, 300.0, 6)
SlowBumpSetting=0
FastBumpRange=(1300.0, 200.0, 6)
FastBumpSetting=0
SlowReboundRange=(5000.0, 300.0, 6)
SlowReboundSetting=0
FastReboundRange=(2500.0, 300.0, 6)
...
PackerSetting=0
SpringMult=1.0                  // take into account suspension motion if spring is not attached to spindle (affects physics but not garage display)
SpringRange=(30000.0, 2500.0, 6)
SpringSetting=0
RideHeightRange=(0.090, -0.0025, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(2000.0, 300.0, 6)
SlowBumpSetting=0
FastBumpRange=(1000.0, 200.0, 6)
FastBumpSetting=0
...
BrakeWearRate=1.215e-011             // meters of wear per second at optimum temperature
BrakeFailure=(1.33e-002,7.20e-004)  // average and variation in disc thickness at failure
BrakeTorque=1000.0                  // maximum brake torque at zero wear and optimum temp
BrakeHeating=0.00070                 // heat added linearly with brake torque
