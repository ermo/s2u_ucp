//  Audi  TT street car  chassis definition file.
//
[GENERAL]
...
Inertia=(1625.0,1725.0,380.0)    // all inertia except fuel
...
Undertray02=(0.75,  0.02, 1.0)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.75, 0.02, 1.0)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
FWDragParams=(0.04, 0.003, 0.0)        // base drag and 1st and 2nd order with setting
...
RWDragParams=(0.04, 0.003, 0.0001)        // base drag and 1st and 2nd order with setting
...
UpshiftDelay=0.08                  // delay in selecting higher gear (low for semi-automatic, higher for manual)
UpshiftClutchTime=0.08             // time to ease auto-clutch in AFTER upshift (0.0 for F1 cars)
...
SpringSetting=0
RideHeightRange=(0.140, -0.00725, 10)
RideHeightSetting=0
DamperMult=1.0                     // take into account suspension motion if damper is not attached to spindle (affects physics but not garage display)
SlowBumpRange=(3000.0, 300.0, 6)
SlowBumpSetting=0
