// Pagani Zonda R Chassis Car file.
...
Mass=1220.0                      // all mass except fuel  (750kg car + 80kg driver weight)
Inertia=(1530.0,1670.0,330.0)    // all inertia except fuel
...
CGRearSetting=0
GraphicalOffset=(0.0, 0.03, 0.00) // does not affect physics!
CollisionOffset=(0.0, 0.02, 0.0) // Moves collision mesh independently of G'offset
Undertray00=(0.85,  0.02, -1.795)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.85, 0.02, -1.795)  // offset from center of car, and between axles// RF (Right front corner of splitter)
...
RWLiftParams=(-0.470, -0.0380, 0.00002)  // base lift and 1st and 2nd order with setting
