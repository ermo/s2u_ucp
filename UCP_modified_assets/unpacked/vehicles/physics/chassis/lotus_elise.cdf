// NFS Lotus Elise street car  chassis definition file.
//
[GENERAL]
//UpgradedTyre="Street_10"
//AdjustableSuspensionLevelStock=0
//AdjustableSuspensionLevelLow=1
//AdjustableSuspensionLevelMid=2
//AdjustableSuspensionLevelHigh=3
TuningTier=3
...
Mass=880.0                      // all mass except fuel  (1100kg car + 80kg driver weight)
Inertia=(1150.0,1200.0,300.0)    // all inertia except fuel
...
Notes=""
Symmetric=1
CGHeight=0.220                  // height of body mass (excluding fuel) above reference plane
CGRightRange=(0.50, 0.000, 0)  // fraction of weight on left tires
CGRightSetting=0
CGRearRange=(0.60, 0.000, 0)
CGRearSetting=0
...
Undertray00=(0.75,  0.02, -1.500)  // offset from center of car, and between axles// LF (Left front corner of splitter) (forward is negative, right is negative)
Undertray01=(-0.75, 0.02, -1.500)  // offset from center of car, and between axles// RF (Right front corner of splitter)
Undertray02=(0.75,  0.02, 1.000)  // offset from center of car, and between axles // LR (Left rear corner of floor
Undertray03=(-0.75, 0.02, 1.000)  // offset from center of car, and between axles // RR (Right rear corner of floor)
...
AIDamperSlow=0.4                // contribution of average slow damper into simple AI damper
...
AITorqueStab=(1.40, 1.60, 1.40)   // torque adjustment to keep AI stable
...
FWDragParams=(0.03, 0.002, 0.0)        // base drag and 1st and 2nd order with setting
FWLiftParams=(-0.000, -0.014, 0.0)  // base lift and 1st and 2nd order with setting
...
RWDragParams=(0.03, 0.003, 0.00)        // base drag and 1st and 2nd order with setting
RWLiftParams=(-0.000, -0.024, 0.00)  // base lift and 1st and 2nd order with setting
...
BodyRot=(2.00, 1.7, 0.80)         // aero torque from rotating 
...
AutoUpshiftGripThresh=0.23          // auto upshift waits until all driven wheels have this much grip (reasonable range: 0.4-0.9)
AutoDownshiftGripThresh=0.23        // auto downshift waits until all driven wheels have this much grip (reasonable range: 0.4-0.9)
...
FinalDriveSetting=14                 // indexed into GearFile list
ReverseSetting=0
ForwardGears=6
Gear1Setting=1
Gear2Setting=24
...
SpringSetting=0
RideHeightRange=(0.115, -0.005, 10)
RideHeightSetting=0
