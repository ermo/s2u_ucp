...
<Reflection>
    ...
    <data class="CarSoundDetails" id="0x18F4C0">
        <prop name="Name" data="nissan_240zgSoundDetails" />
        ...
        <prop name="TransmissionVolume" data="0.4" />
        <prop name="TransmissionFrequencyMultiplier" data="1" />
        <prop name="SurfaceVolume" data="0.4" />
        ...
        <prop name="BrakesVolume" data="0.5" />
        <prop name="GearChangeVolume" data="0.5" />
        <prop name="ExhaustSplutterVolume" data="0.6" />
        <prop name="ExhaustSplutterRatio" data="0.5" />
        <prop name="ExhaustBackfireVolume" data="0.6" />
        <prop name="ExhaustBackfireRatio" data="0.5" />
        <prop name="BrakeSquealVolume" data="0.6" />
        <prop name="SurfaceGripRatio" data="0.9" />
        <prop name="WindVolume" data="1" />
        <prop name="WindVelocityMultiplier" data="1" />
        <prop name="EngineSoundName" data="240ZG" />
        <prop name="SwapEngineSoundName" data="Nissan_R34" />
        <prop name="TurboSoundName" data="" />
        <prop name="TransmissionSoundName" data="Sports1" />
        <prop name="GearChangeSoundName" data="Race" />
        <prop name="ExhaustSplutterSoundName" data="General" />
        <prop name="ExhaustBackfireSoundName" data="General" />
        ...
        <prop name="BumpStopSoundName" data="CarImpact_Bumpstop_Street" />
        <prop name="WindSoundName" data="" />
    </data>
</Reflection>
