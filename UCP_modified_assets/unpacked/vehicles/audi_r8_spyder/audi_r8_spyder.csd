...
<Reflection>
    ...
    <data class="CarSoundDetails" id="0x18F4C0">
        ...
        <prop name="SurfaceVolume" data="0.7" />
        ...
        <prop name="BrakesVolume" data="0.6" />
        <prop name="GearChangeVolume" data="0.7" />
        ...
        <prop name="SurfaceGripRatio" data="0.85" />
        <prop name="WindVolume" data="1" />
        <prop name="WindVelocityMultiplier" data="1" />
        <prop name="EngineSoundName" data="Gallardo" />
        <prop name="SwapEngineSoundName" data="Gallardo" />
        <prop name="TurboSoundName" data="" />
        <prop name="TransmissionSoundName" data="Race1" />
        <prop name="GearChangeSoundName" data="Sports" />
